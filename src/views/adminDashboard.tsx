                      ...
                      <tbody className="divide-y divide-gray-200">
                        {userList.users.map((u, index) => (
                          <tr key={index} className="hover:bg-gray-100">
                            <td className="px-6 py-2 whitespace-nowrap text-start text-sm text-gray-800">{u.name}</td>
                            <td className="px-6 py-2 whitespace-nowrap text-start text-sm text-gray-800">{u.email}</td>
                            <td className="px-6 py-2 whitespace-nowrap text-start text-sm text-gray-800">{u.roles?.map((r) => r.role).join(', ')}</td>
                            <td className="px-6 py-2 whitespace-nowrap text-end text-sm font-medium">
                              <button type="button" className="px-2 py-1 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-1 border-orange-400 text-orange-400 hover:border-orange-800 hover:text-orange-800" onClick={() => deleteUser(u.id!)}>
                                <TrashIcon />
                                Delete
                              </button>
                            </td>
